...
public class ParkController {
	...
	public void deleteAllContributors() {
		...
		throw new UnsupportedOperationException("Deleting all contributors is prohibited.");
	}
	...
	public PetParkData rertievedPetParkById1(@PathVariable Long contributorId, @PathVariable Long parkId) {
